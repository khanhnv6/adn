...
In order to support loading of multiple wallets in adn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is adn.cpp.
...
Changes to adn.cpp
----------------------
adn.cpp is the entry point into adn-qt, and as such, will require some minor modifications to provide hooks for
