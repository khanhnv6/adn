...
RESOURCES += src/qt/adn.qrc src/qt/adn_locale.qrc

TRANSLATIONS += src/qt/locale/adn_bg.ts \
                src/qt/locale/adn_de.ts \
                src/qt/locale/adn_en.ts \
                src/qt/locale/adn_es.ts \
                src/qt/locale/adn_fi.ts \
                src/qt/locale/adn_fr.ts \
                src/qt/locale/adn_it.ts \
                src/qt/locale/adn_ja.ts \
                src/qt/locale/adn_pl.ts \
                src/qt/locale/adn_pt.ts \
                src/qt/locale/adn_ru.ts \
                src/qt/locale/adn_sk.ts \
                src/qt/locale/adn_sv.ts \
                src/qt/locale/adn_vi.ts \
                src/qt/locale/adn_zh_CN.ts \
                src/qt/locale/adn_zh_TW.ts
