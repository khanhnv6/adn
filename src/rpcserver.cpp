...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Adn features */
        {"adn", "masternode", &masternode, true, true, false},
        {"adn", "listmasternodes", &listmasternodes, true, true, false},
        {"adn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"adn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"adn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"adn", "masternodedebug", &masternodedebug, true, true, false},
        {"adn", "startmasternode", &startmasternode, true, true, false},
        {"adn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"adn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"adn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"adn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"adn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"adn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"adn", "mnbudget", &mnbudget, true, true, false},
        {"adn", "preparebudget", &preparebudget, true, true, false},
        {"adn", "submitbudget", &submitbudget, true, true, false},
        {"adn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"adn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"adn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"adn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"adn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"adn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"adn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"adn", "checkbudgets", &checkbudgets, true, true, false},
        {"adn", "mnsync", &mnsync, true, true, false},
        {"adn", "spork", &spork, true, true, false},
        {"adn", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"adn", "coinmixing", &coinmixing, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use adnd, or the -server option to adn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> adn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23203/\n";
}
