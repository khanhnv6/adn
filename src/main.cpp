...
#if defined(NDEBUG)
#error "ADN cannot be compiled without assertions."
#endif
...
int GetInputAgeIX(uint256 nTXHash, CTxIn& vin)
{
    ...
    if (nResult < 6) {
        ...
        if (sigs >= LIGHTINGSEND_SIGNATURES_REQUIRED) {
...
bool AcceptToMemoryPool(CTxMemPool& pool, CValidationState& state, const CTransaction& tx, bool fLimitFree, bool* pfMissingInputs, bool fRejectInsaneFee, bool ignoreFees)
{
    ...
    // ----------- lightingSEND transaction scanning -----------
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        nSubsidyP = 2784000;
    } else if (nHeight < 235 && nHeight > 0) {
        nSubsidyP = 0.25;
    } else if (nHeight < 10368 && nHeight >=235 ) {
        nSubsidyP = 0.5;
    } else if (nHeight < 17280 && nHeight >=10368 ) {
        nSubsidyP =  50;
    } else if (nHeight < 20736 && nHeight >= 17280) {
        nSubsidyP = 60;
    } else if (nHeight < 27648 && nHeight >= 20736) {
        nSubsidyP = 70;
    } else if (nHeight < 31104 && nHeight >= 27648) {
        nSubsidyP = 80;
    } else if (nHeight < 38016 && nHeight >= 31104) {
        nSubsidyP = 90;
    } else if (nHeight < 41472 && nHeight >= 38016) {
        nSubsidyP = 100;
    } else if (nHeight < 48384  && nHeight >= 41472) {
        nSubsidyP = 110;
    } else if (nHeight < 51840 && nHeight >= 48384) {
        nSubsidyP = 120;
    } else if (nHeight < 58752 && nHeight >= 51840) {
        nSubsidyP = 130;
    } else if (nHeight < 62208 && nHeight >= 58752) {
        nSubsidyP = 140;
    } else if (nHeight < 65664 && nHeight >= 62208) {
        nSubsidyP = 100;
    } else if (nHeight < 69120 && nHeight >= 65664) {
        nSubsidyP = 80;
    } else if (nHeight < 72576 && nHeight >= 69120) {
        nSubsidyP = 70;
    } else if (nHeight < 76032 && nHeight >= 72576) {
        nSubsidyP = 60;
    } else if (nHeight < 79488 && nHeight >= 76032) {
        nSubsidyP = 50;
    } else if (nHeight < 82944 && nHeight >= 79488) {
        nSubsidyP = 40;
    } else if (nHeight < 86400 && nHeight >= 82944) {
        nSubsidyP = 30;
    } else if (nHeight < 89856 && nHeight >= 86400) {
        nSubsidyP = 20;
    } else if (nHeight < 15230592 && nHeight >= 89856) {
        nSubsidyP = 10;
    } else if (nHeight >= 15230592) {
        nSubsidyP = 0;
    } else {
        nSubsidyP = 0;
    }
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight == 0) {
        ...
        ret = blockValue - 0.25 * COIN;
    } else if (nHeight < 17280 && nHeight >=10368 ) {
        ret = blockValue - 25 * COIN;
    } else if (nHeight < 20736 && nHeight >= 17280) {
        ret = blockValue - 27 * COIN;
    } else if (nHeight < 27648 && nHeight >= 20736) {
        ret = blockValue - 28 * COIN;
    } else if (nHeight < 31104 && nHeight >= 27648) {
        ret = blockValue - 28 * COIN;
    } else if (nHeight < 38016 && nHeight >= 31104) {
        ret = blockValue - 27 * COIN;
        ...
        ret = blockValue - 22 * COIN;
    } else if (nHeight < 51840 && nHeight >= 48384) {
        ret = blockValue - 18 * COIN;
    } else if (nHeight < 58752 && nHeight >= 51840) {
        ret = blockValue - 13 * COIN;
    } else if (nHeight < 62208 && nHeight >= 58752) {
        ret = blockValue - 7 * COIN;
    } else if (nHeight < 65664 && nHeight >= 62208) {
        ret = blockValue - 10 * COIN;
    } else if (nHeight < 69120 && nHeight >= 65664) {
        ret = blockValue - 12 * COIN;
    } else if (nHeight < 72576 && nHeight >= 69120) {
        ret = blockValue - 14 * COIN;
    } else if (nHeight < 76032 && nHeight >= 72576) {
        ret = blockValue - 15 * COIN;
    } else if (nHeight < 79488 && nHeight >= 76032) {
        ret = blockValue - 15 * COIN;
    } else if (nHeight < 82944 && nHeight >= 79488) {
        ret = blockValue - 14 * COIN;
...
/*
    ...
    Remove conflicting blocks for successful LightningSend transaction locks
...
bool CheckBlock(const CBlock& block, CValidationState& state, bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig)
{
    ...
    if (IsSporkActive(SPORK_3_LIGHTINGSEND_BLOCK_FILTERING)) {
        BOOST_FOREACH (const CTransaction& tx, block.vtx) {
            if (!tx.IsCoinBase()) {
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    // getaddr message mitigates the attack.
        ...
        coinMixingPool.ProcessMessageCoinMixing(pfrom, strCommand, vRecv);
        mnodeman.ProcessMessage(pfrom, strCommand, vRecv);
        budget.ProcessMessage(pfrom, strCommand, vRecv);
        masternodePayments.ProcessMessageMasternodePayments(pfrom, strCommand, vRecv);
        ProcessMessageLightningSend(pfrom, strCommand, vRecv);
