...
#define SPORK_2_LIGHTINGSEND 10001
#define SPORK_3_LIGHTINGSEND_BLOCK_FILTERING 10002
...
#define SPORK_2_LIGHTINGSEND_DEFAULT 978307200                         //2001-1-1
#define SPORK_3_LIGHTINGSEND_BLOCK_FILTERING_DEFAULT 1424217600        //2015-2-18
#define SPORK_5_MAX_VALUE_DEFAULT 1000                            //1000 ADN
...
#define SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2_DEFAULT 1533517200    //Mon, 06 Aug 2018 01:00:00 UTC
...
public:
    ...
    uint256 GetHash()
    {
        uint256 n = HashBlack(BEGIN(nSporkID), END(nTimeSigned));
        return n;
    }
