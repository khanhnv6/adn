                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ADN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ADN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and adn: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ADN Core"), this);
    aboutAction->setStatusTip(tr("Show information about ADN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ADN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ADN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ADN addresses"));
    ...
    openAction->setStatusTip(tr("Open a ADN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ADN Core help message to get a list with possible ADN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ADN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ADN network", "", count));
}
...
{
    QString strTitle = tr("ADN Core"); // default title
