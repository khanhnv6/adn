Contributing to ADN Core
============================

The ADN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ADN Core project, and is not to be
confused with overall ADN Network Protocol consensus changes.

Whether a pull request is merged into ADN Core rests with the project merge
...
Patches that change ADN consensus rules are considerably more involved than
...
Where a patch set proposes to change the ADN consensus, it must have been
...
The project leader is the release manager for each ADN Core release.
